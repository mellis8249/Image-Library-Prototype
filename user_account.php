...
<body>
    ...
    <div class="band contentUserAccount"><!--Div class for band content-->
        <div class="container"><!--Div class for container-->
            <h2>My Account</h2>
            <div class="five columns" id="email"><!--Div class for ten columns-->
                <?php 
                require 'login/updatePassword.php'; ?><!--Requires updatePassword.php
            </div><!--End Div for ten columns-->
            <div class-"five columns" id="password"><!--Div for five columns-->
            <?php
            require 'login/updateEmail.php'; ?><!--Requires updateEmail.php
            </div><!--End Div for five columns-->
    </div><!--End Div for container-->
