...
if($_POST) //Post Data received from product list page.
{
	...
	//$_SESSION["paypal_assets"] = $paypal_assets;
...
if(isset($_GET["token"]) && isset($_GET["PayerID"]))
{
  ...
  // header("Location: http://example.com/myOtherPage.php");
      //header("Location: http://valadan.co.uk/prototype");
      
   echo '<meta http-equiv="refresh" content= "0;URL=http://www.valadan.co.uk/prototype/final.php" />';
