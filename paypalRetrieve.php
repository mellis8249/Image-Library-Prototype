<?php
//Require classes
require_once 'config/paypalConfiguration.php';
require_once 'includes/classes/paypal.class.php';
	...
	if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) 
	{
		...
		*/
		...
		if('Completed' == $httpParsedResponseAr["PAYMENTINFO_0_PAYMENTSTATUS"])
		{
			...
			$productslol = $_SESSION['paypal_products'];
		    $firstname = $_SESSION['firstname'];
			$lastname = $_SESSION['lastname'];
				  
			$email = $_SESSION['email'];
	
			foreach($productslol['items'] as $key=>$p_item){
			    $id = $p_item['itm_code'];
				      
			    $result = $db->query("SELECT Original, ImageName FROM images WHERE ImageID = $id", null, PDO::FETCH_ASSOC);
          ...
          $message1 = $imageName . " ". $firstname . " " . $lastname . "\n\n" . "Thank you for selecting the following image:" . "\n\n" . "www.valadan.co.uk/ImageLibrary$original";
          $message2 = $firstname . " " . $lastname . "\n\n" . "Selected the following image:" . "\n\n" .  "www.valadan.co.uk/ImageLibrary/$original";
          $headers = 'From: m.ellis@valadan.co.uk' . "\r\n" . 'm.ellis@valadan.co.uk';
          $headers = "From:" . $to;
          $headers = "From:" . $from;
          ...
          mail($from, $subject2, $message2, $headers);
				...
				echo "</br>";
				echo '<div style="color:green">Payment Received! Your product will be sent to you very soon via the Email you used to register with!</div>';
		        }
